...
f = [
    KeepTogether([mn, t_u, un, s_80, kaf, s_80, tp, title, var, s_130, fac, gr, st, tchr, mk, s_130, sity]),
     ...
     Image(r'C:\Users\kasht\Documents\Учёба\6 семестр\Переходные процессы\Курсовая\Схемы\Экспортировано\Схема.png',
